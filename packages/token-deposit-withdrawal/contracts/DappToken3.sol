...
contract DappToken3{
  ...
  string public name = "Dapp Token_3";        //Token name
  string public symbol = "DAPP_3";            //Token symbol
  string public standard = "Dapp Token v3.0";
  uint256 public totalSupply;
  uint8 public decimals = 2;
  
  
  mapping(address => uint256) public _balanceOf;    //stores the balance of addresses. Every time a token is baught/sold/transferred, this mapping is responsible for knowing who has each token
  ...
  constructor (uint256 _initialSupply) public{
    ...
    _balanceOf[msg.sender] = _initialSupply;   //allocates the initial supply
  ...
  function transferFrom (address _from, address _to, uint256 _value) public returns (bool success){
    ...
    _balanceOf[_from] -= _value;  //update the balance of _from and _to
    _balanceOf[_to] += _value;     //update the balance of _from and _to
